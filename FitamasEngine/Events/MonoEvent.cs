...
{
    public abstract class MonoEventBase
    {
    ...
    public class MonoEvent : MonoEventBase
    {
        public MonoEvent(params MonoAction[] actions)
        {
    ...
    public class MonoEvent<T0> : MonoEventBase
    {
        public MonoEvent(params MonoAction<T0>[] actions)
        {
            foreach (var action in actions)
            {
                AddListener(action);
    ...
    public class MonoEvent<T0, T1> : MonoEventBase
    {
        public MonoEvent(params MonoAction<T0, T1>[] actions)
        {
            foreach (var action in actions)
            {
                AddListener(action);
