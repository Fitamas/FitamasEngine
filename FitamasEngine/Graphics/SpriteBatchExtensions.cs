...
namespace Fitamas.Graphics
{
    public static class SpriteBatchExtensions
    {
        ...
        /// <param name="angle">The angle in radians to draw the rectangle at</param>
        /// <param name="color">The color to draw the rectangle in</param>
        public static void FillRectangle(this SpriteBatch spriteBatch, Vector2 location, Vector2 size, Color color, float angle, float layer = 0)
        {
            if (pixel == null)
            {
                CreateThePixel(spriteBatch);
            ...
            spriteBatch.Draw(pixel, location, null,
                             color, angle, Vector2.Zero,
                             size, SpriteEffects.None, layer);
        }
