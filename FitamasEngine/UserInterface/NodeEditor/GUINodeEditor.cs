...
using Fitamas.UserInterface.NodeEditor.Controllers;
...
namespace Fitamas.UserInterface.NodeEditor
{
    ...
    public class GUINodeEditor : GUIComponent, IMouseEvent, IDragMouseEvent, IKeyboardEvent
    {
        ...
        protected override void OnInit()
        {
            ...
            backGround.AutoSortingLayer = false;
            backGround.Layer = 0;
        ...
        protected override void OnUpdate(GameTime gameTime)
        {
            ...
            Point localPosition = ToLocalPosition(mousePosition);
        ...
        {
            if (!OnMouse && (eventType == GUIEventType.Click || eventType == GUIEventType.StartDrag))
            {
                return;
            }

            System.keyboardSubscriber = this;

            Point localPosition = ToLocalPosition(mouse.Position);
