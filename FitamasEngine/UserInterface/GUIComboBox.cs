...
namespace Fitamas.UserInterface
{
    ...
    {
        [SerializableField] private Dictionary<GUIComponent, int> dictionary;
        [SerializableField] private string[] items;
        ...
        public GUIComboBox(Rectangle rectangle, IEnumerable<string> items, int selectItem = 0) : base(rectangle)
        {
            SetItems(items);
        ...
        public void SetItems(IEnumerable<string> items)
        {
            ...
            {
                GUIButton button = new GUIButton(new Rectangle(new Point(), Rectangle.Size));
