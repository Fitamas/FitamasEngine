...
namespace Fitamas.ImGuiNet
{
    ...
    {
        public ComponentMapper Mapper { get; set; }
    ...
    public class TransformEditor : EditorComponent
    {
    ...
    public class MeshEditor : EditorComponent
    {
        public override void OnInspectorGUI()
        {
    ...
    public class TextureAtlas : EditorComponent
    {
        public override void OnInspectorGUI()
        {
            base.OnInspectorGUI();
